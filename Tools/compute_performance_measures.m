function [distance_precision, PASCAL_precision, average_center_location_error] = ...
    compute_performance_measures(positions, ground_truth,video,distance_precision_threshold, PASCAL_threshold)
...
%threshold(1-100,1-50)precision
pre_o=zeros(1,100);
pre_d=zeros(1,50);
for thre=1:100
...
save (['../Results/eval_results/' video '.mat'] ,'pre_o', 'pre_d');
